...
with col1:
    ...
    st.markdown(f'<p style="text-align:center; background-color:#f5f5ed;color:#0d0d0c;font-family:Arial Black;font-size:40px;border-radius:0%;">United Arab Emirates</p>', unsafe_allow_html=True)
with col3:
    #Month 
